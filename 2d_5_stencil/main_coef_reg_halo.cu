        ...
        int m, int n, int halo) 
{
    ...
    sum0 += a0*((lane_id < 31)? tx0: ty0);
    sum1 += a0*((lane_id < 29)? tx1: ty1);
    sum2 += a0*((lane_id < 27)? tx2: ty2);
    sum3 += a0*((lane_id < 25)? tx3: ty3);
    ...
    sum0 += a1*((lane_id < 30)? tx0: ty0);
    sum1 += a1*((lane_id < 28)? tx1: ty1);
    sum2 += a1*((lane_id < 26)? tx2: ty2);
    sum3 += a1*((lane_id < 24)? tx3: ty3);
    ...
    sum0 += a2*((lane_id < 27)? tx0: ty0);
    sum1 += a2*((lane_id < 25)? tx1: ty1);
    sum2 += a2*((lane_id < 23)? tx2: ty2);
    sum3 += a2*((lane_id < 21)? tx3: ty3);
...
int main(int argc, char **argv)
{
    ...
    {
        Stencil_Seq(in, out_ref, args[0], args[1], args[2], args[3], args[4], m, n, halo);
        swap(in, out_ref);
    }
    swap(in, out_ref);
