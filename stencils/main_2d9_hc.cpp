...
void Stencil_Hcc_Shfl(array<DATA_TYPE> &in, array<DATA_TYPE> &out, array<DATA_TYPE> &args, int m, int n, int halo) 
{
    ...
    completion_future fut = parallel_for_each(compute_tile, [=, &in, &out, &args](tiled_index<2> tidx) restrict(amp) {
        ...
        // eastern 
        friend_id = (friend_id+1)&(warpSize-1);
        tx = args[5]*__shfl(threadInput0, friend_id, 64);
        ty = args[5]*__shfl(threadInput1, friend_id, 64);
        ...
        // southern
        friend_id = (friend_id+1)&(warpSize-1);
        tx = args[7]*__shfl(threadInput0, friend_id, 64);
        ty = args[7]*__shfl(threadInput1, friend_id, 64);
...
void Stencil_Hcc_Shfl2(array<DATA_TYPE> &in, array<DATA_TYPE> &out, array<DATA_TYPE> &args, int m, int n, int halo) 
{
    ...
    completion_future fut = parallel_for_each(compute_tile, [=, &in, &out, &args](tiled_index<2> tidx) restrict(amp) {
        ...
        friend_id0 = (friend_id0+1)&(warpSize-1);
        friend_id1 = (friend_id1+1)&(warpSize-1);
        tx0 = args[5]*__shfl(threadInput0, friend_id0, 64);
        ty0 = args[5]*__shfl(threadInput1, friend_id0, 64);
        tx1 = args[5]*__shfl(threadInput1, friend_id1, 64);
        ty1 = args[5]*__shfl(threadInput2, friend_id1, 64);
        ...
        friend_id0 = (friend_id0+1)&(warpSize-1);
        friend_id1 = (friend_id1+1)&(warpSize-1);
        tx0 = args[7]*__shfl(threadInput0, friend_id0, 64);
        ty0 = args[7]*__shfl(threadInput1, friend_id0, 64);
        tx1 = args[7]*__shfl(threadInput1, friend_id1, 64);
        ty1 = args[7]*__shfl(threadInput2, friend_id1, 64);
...
void Stencil_Hcc_Shfl2x(array<DATA_TYPE> &in, array<DATA_TYPE> &out, array<DATA_TYPE> &args, int m, int n, int halo) 
{
    extent<2> compute_domain((m+1)/2+31, n+7); 
    tiled_extent<2> compute_tile(compute_domain, 32, 8);
    completion_future fut = parallel_for_each(compute_tile, [=, &in, &out, &args](tiled_index<2> tidx) restrict(amp) {
...
void Stencil_Hcc_Shfl4x(array<DATA_TYPE> &in, array<DATA_TYPE> &out, array<DATA_TYPE> &args, int m, int n, int halo) 
{
    ...
    completion_future fut = parallel_for_each(compute_tile, [=, &in, &out, &args](tiled_index<2> tidx) restrict(amp) {
        ...
        // tx1 = args[5]*__shfl(threadInput1, friend_id1, 64);
        // ty1 = args[5]*__shfl(threadInput2, friend_id1, 64);
        // tx2 = args[5]*__shfl(threadInput2, friend_id2, 64);
        // ty2 = args[5]*__shfl(threadInput3, friend_id2, 64);
        // tx3 = args[5]*__shfl(threadInput3, friend_id3, 64);
        // ty3 = args[5]*__shfl(threadInput4, friend_id3, 64);
        // tz3 = args[5]*__shfl(threadInput5, friend_id3, 64);
        sum0 += (lane_id < 42)? tx0: ty0;
        // sum1 += (lane_id < 30)? tx1: ty1;
        ...
        // tx1 = args[7]*__shfl(threadInput1, friend_id1, 64);
        // ty1 = args[7]*__shfl(threadInput2, friend_id1, 64);
        // tx2 = args[7]*__shfl(threadInput2, friend_id2, 64);
        // ty2 = args[7]*__shfl(threadInput3, friend_id2, 64);
        // tz2 = args[7]*__shfl(threadInput4, friend_id2, 64);
        // tx3 = args[7]*__shfl(threadInput4, friend_id3, 64);
        // ty3 = args[7]*__shfl(threadInput5, friend_id3, 64);
        sum0 += (lane_id < 35)? tx0: ty0;
        // sum1 += (lane_id < 23)? tx1: ty1;
...
void Stencil_Hcc_Shfl4_2(array<DATA_TYPE> &in, array<DATA_TYPE> &out, array<DATA_TYPE> &args, int m, int n, int halo) 
{
    ...
    completion_future fut = parallel_for_each(compute_tile, [=, &in, &out, &args](tiled_index<2> tidx) restrict(amp) {
        ...
        tx0 = args[5]*__shfl(threadInput0, friend_id0, 64);
        ty0 = args[5]*__shfl(threadInput1, friend_id0, 64);
        tz0 = args[5]*__shfl(threadInput2, friend_id0, 64);
        tx1 = args[5]*__shfl(threadInput0, friend_id1, 64);
        ty1 = args[5]*__shfl(threadInput1, friend_id1, 64);
        tz1 = args[5]*__shfl(threadInput2, friend_id1, 64);
        tx2 = args[5]*__shfl(threadInput2, friend_id2, 64);
        ty2 = args[5]*__shfl(threadInput3, friend_id2, 64);
        tz2 = args[5]*__shfl(threadInput4, friend_id2, 64);
        tx3 = args[5]*__shfl(threadInput2, friend_id3, 64);
        ty3 = args[5]*__shfl(threadInput3, friend_id3, 64);
        tz3 = args[5]*__shfl(threadInput4, friend_id3, 64);
        ...
        tx0 = args[7]*__shfl(threadInput0, friend_id0, 64);
        ty0 = args[7]*__shfl(threadInput1, friend_id0, 64);
        tz0 = args[7]*__shfl(threadInput2, friend_id0, 64);
        tx1 = args[7]*__shfl(threadInput0, friend_id1, 64);
        ty1 = args[7]*__shfl(threadInput1, friend_id1, 64);
        tz1 = args[7]*__shfl(threadInput2, friend_id1, 64);
        tx2 = args[7]*__shfl(threadInput2, friend_id2, 64);
        ty2 = args[7]*__shfl(threadInput3, friend_id2, 64);
        tz2 = args[7]*__shfl(threadInput4, friend_id2, 64);
        tx3 = args[7]*__shfl(threadInput2, friend_id3, 64);
        ty3 = args[7]*__shfl(threadInput3, friend_id3, 64);
        tz3 = args[7]*__shfl(threadInput4, friend_id3, 64);
        ta3 = args[7]*__shfl(threadInput5, friend_id3, 64);
...
void Stencil_Hcc_Shfl8(array<DATA_TYPE> &in, array<DATA_TYPE> &out, array<DATA_TYPE> &args, int m, int n, int halo) 
{
    ...
    completion_future fut = parallel_for_each(compute_tile, [=, &in, &out, &args](tiled_index<2> tidx) restrict(amp) {
        ...
        ty3 = args[5]*__shfl(threadInput4, friend_id3, 64);
        tz3 = args[5]*__shfl(threadInput5, friend_id3, 64);
        rx0 = args[5]*__shfl(threadInput5, friend_id0, 64);
        ry0 = args[5]*__shfl(threadInput6, friend_id0, 64);
        rx1 = args[5]*__shfl(threadInput6, friend_id1, 64);
        ry1 = args[5]*__shfl(threadInput7, friend_id1, 64);
        rx2 = args[5]*__shfl(threadInput7, friend_id2, 64);
        ry2 = args[5]*__shfl(threadInput8, friend_id2, 64);
        rx3 = args[5]*__shfl(threadInput8, friend_id3, 64);
        ry3 = args[5]*__shfl(threadInput9, friend_id3, 64);
        rz3 = args[5]*__shfl(threadInput10, friend_id3, 64);
        ...
        tx3 = args[7]*__shfl(threadInput4, friend_id3, 64);
        ty3 = args[7]*__shfl(threadInput5, friend_id3, 64);
        rx0 = args[7]*__shfl(threadInput5, friend_id0, 64);
        ry0 = args[7]*__shfl(threadInput6, friend_id0, 64);
        rx1 = args[7]*__shfl(threadInput6, friend_id1, 64);
        ry1 = args[7]*__shfl(threadInput7, friend_id1, 64);
        rx2 = args[7]*__shfl(threadInput7, friend_id2, 64);
        ry2 = args[7]*__shfl(threadInput8, friend_id2, 64);
        rz2 = args[7]*__shfl(threadInput9, friend_id2, 64);
        rx3 = args[7]*__shfl(threadInput9, friend_id3, 64);
        ry3 = args[7]*__shfl(threadInput10, friend_id3, 64);
