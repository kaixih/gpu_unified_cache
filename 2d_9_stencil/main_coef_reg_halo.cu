...
__global__ void Stencil_Cuda_Shfl2_2DWarp(DATA_TYPE *in, DATA_TYPE *out, DATA_TYPE a0, DATA_TYPE a1, 
        DATA_TYPE a2, DATA_TYPE a3, DATA_TYPE a4, 
        DATA_TYPE a5, DATA_TYPE a6, DATA_TYPE a7, DATA_TYPE a8,
        int m, int n, int halo) 
{
...
__global__ void Stencil_Cuda_Shfl_1DWarp(DATA_TYPE *in, DATA_TYPE *out, DATA_TYPE a0, DATA_TYPE a1, 
        DATA_TYPE a2, DATA_TYPE a3, DATA_TYPE a4, 
        DATA_TYPE a5, DATA_TYPE a6, DATA_TYPE a7, DATA_TYPE a8,
        int m, int n, int halo) 
{
...
__global__ void Stencil_Cuda_Shfl2_1DWarp(DATA_TYPE *in, DATA_TYPE *out, DATA_TYPE a0, DATA_TYPE a1, 
        DATA_TYPE a2, DATA_TYPE a3, DATA_TYPE a4, 
        DATA_TYPE a5, DATA_TYPE a6, DATA_TYPE a7, DATA_TYPE a8,
        int m, int n, int halo) 
{
...
__global__ void Stencil_Cuda_Shfl4_1DWarp(DATA_TYPE *in, DATA_TYPE *out, DATA_TYPE a0, DATA_TYPE a1, 
        DATA_TYPE a2, DATA_TYPE a3, DATA_TYPE a4, 
        DATA_TYPE a5, DATA_TYPE a6, DATA_TYPE a7, DATA_TYPE a8,
        int m, int n, int halo) 
{
...
__global__ void Stencil_Cuda_Shfl4_2DWarp(DATA_TYPE *in, DATA_TYPE *out, DATA_TYPE a0, DATA_TYPE a1, 
        DATA_TYPE a2, DATA_TYPE a3, DATA_TYPE a4, 
        DATA_TYPE a5, DATA_TYPE a6, DATA_TYPE a7, DATA_TYPE a8,
        int m, int n, int halo) 
{
        ...
        int m, int n, int halo) 
{
    ...
    sum1 += a0*((lane_id < 14)? tx1: ((lane_id < 26)? ty1: tz1));
    sum2 += a0*((lane_id < 14)? tx2: ((lane_id < 26)? ty2: tz2));
    ...
    ty3 = __shfl(threadInput3, friend_id3);
    tz3 = __shfl(threadInput4, friend_id3);
    sum0 += a1*((lane_id < 16)? tx0: ty0);
    sum1 += a1*((lane_id < 13)? tx1: ((lane_id < 25)? ty1: tz1));
    sum2 += a1*((lane_id < 13)? tx2: ((lane_id < 25)? ty2: tz2));
    sum3 += a1*((lane_id < 8 )? tx3: ((lane_id < 24)? ty3: tz3));
    ...
    sum1 += a2*((lane_id < 12)? tx1: ((lane_id < 24)? ty1: tz1));
    sum2 += a2*((lane_id < 12)? tx2: ((lane_id < 24)? ty2: tz2));
    sum3 += a2*((lane_id < 8 )? tx3: ((lane_id < 24)? ty3: tz3));
    ...
    sum1 += a3*((lane_id < 6 )? tx1: ((lane_id < 18)? ty1: tz1));
    sum2 += a3*((lane_id < 6 )? tx2: ((lane_id < 18)? ty2: tz2));
    sum3 += a3*((lane_id < 16)? tx3: ty3);
    ...
    ty3 = __shfl(threadInput4, friend_id3);
    tz3 = __shfl(threadInput5, friend_id3);
    sum0 += a5*((lane_id < 8 )? tx0: ((lane_id < 24)? ty0: tz0));
    sum1 += a5*((lane_id < 4 )? tx1: ((lane_id < 16)? ty1: tz1));
    sum2 += a5*((lane_id < 4 )? tx2: ((lane_id < 16)? ty2: tz2));
    sum3 += a5*((lane_id < 16)? tx3: ((lane_id < 30)? ty3: tz3));
    ...
    ty3 = __shfl(threadInput4, friend_id3);
    tz3 = __shfl(threadInput5, friend_id3);
    sum0 += a6*((lane_id < 16)? tx0: ((lane_id < 30)? ty0: tz0));
    sum1 += a6*((lane_id < 10)? tx1: ((lane_id < 24)? ty1: tz1));
    sum2 += a6*((lane_id < 10)? tx2: ((lane_id < 24)? ty2: tz2));
    sum3 += a6*((lane_id < 8 )? tx3: ((lane_id < 24)? ty3: tz3));
    ...
    ty3 = __shfl(threadInput4, friend_id3);
    tz3 = __shfl(threadInput5, friend_id3);
    sum0 += a7*((lane_id < 16)? tx0: ((lane_id < 29)? ty0: tz0));
    sum1 += a7*((lane_id < 9 )? tx1: ((lane_id < 24)? ty1: tz1));
    sum2 += a7*((lane_id < 9 )? tx2: ((lane_id < 24)? ty2: tz2));
    sum3 += a7*((lane_id < 8 )? tx3: ((lane_id < 23)? ty3: tz3));
    ...
    ty3 = __shfl(threadInput4, friend_id3);
    tz3 = __shfl(threadInput5, friend_id3);
    sum0 += a8*((lane_id < 16)? tx0: ((lane_id < 28)? ty0: tz0));
    sum1 += a8*((lane_id < 8 )? tx1: ((lane_id < 24)? ty1: tz1));
    sum2 += a8*((lane_id < 8 )? tx2: ((lane_id < 24)? ty2: tz2));
    sum3 += a8*((lane_id < 8 )? tx3: ((lane_id < 22)? ty3: tz3));
        ...
        int m, int n, int halo) 
{
    ...
    sum5 += a0*((lane_id < 8 )? rx1: ((lane_id < 20)? ry1: rz1));
    sum6 += a0*((lane_id < 8 )? rx2: ((lane_id < 20)? ry2: rz2));
    ...
    sum2 += a1*((lane_id < 13)? tx2: ((lane_id < 25)? ty2: tz2));
    sum3 += a1*((lane_id < 8 )? tx3: ((lane_id < 24)? ty3: tz3));
    sum4 += a1*((lane_id < 8 )? rx0: ((lane_id < 24)? ry0: rz0));
    sum5 += a1*((lane_id < 7 )? rx1: ((lane_id < 19)? ry1: rz1));
    sum6 += a1*((lane_id < 7 )? rx2: ((lane_id < 19)? ry2: rz2));
    sum7 += a1*((lane_id < 16)? rx3: ry3);
    ...
    sum2 += a2*((lane_id < 12)? tx2: ((lane_id < 24)? ty2: tz2));
    sum3 += a2*((lane_id < 8 )? tx3: ((lane_id < 24)? ty3: tz3));
    sum4 += a2*((lane_id < 8 )? rx0: ((lane_id < 24)? ry0: rz0));
    sum5 += a2*((lane_id < 6 )? rx1: ((lane_id < 18)? ry1: rz1));
    sum6 += a2*((lane_id < 6 )? rx2: ((lane_id < 18)? ry2: rz2));
    sum7 += a2*((lane_id < 16)? rx3: ry3);
    ...
    sum5 += a3*((lane_id < 12)? rx1: ((lane_id < 24)? ry1: rz1));
    sum6 += a3*((lane_id < 12)? rx2: ((lane_id < 24)? ry2: rz2));
    ...
    sum2 += a5*((lane_id < 4 )? tx2: ((lane_id < 16)? ty2: tz2));
    sum3 += a5*((lane_id < 16)? tx3: ((lane_id < 30)? ty3: tz3));
    sum4 += a5*((lane_id < 16)? rx0: ((lane_id < 30)? ry0: rz0));
    sum5 += a5*((lane_id < 10)? rx1: ((lane_id < 24)? ry1: rz1));
    sum6 += a5*((lane_id < 10)? rx2: ((lane_id < 24)? ry2: rz2));
    sum7 += a5*((lane_id < 8 )? rx3: ((lane_id < 24)? ry3: rz3));
    ...
    sum2 += a6*((lane_id < 10)? tx2: ((lane_id < 24)? ty2: tz2));
    sum3 += a6*((lane_id < 8 )? tx3: ((lane_id < 24)? ty3: tz3));
    sum4 += a6*((lane_id < 8 )? rx0: ((lane_id < 24)? ry0: rz0));
    sum5 += a6*((lane_id < 4 )? rx1: ((lane_id < 16)? ry1: rz1));
    sum6 += a6*((lane_id < 4 )? rx2: ((lane_id < 16)? ry2: rz2));
    sum7 += a6*((lane_id < 16)? rx3: ((lane_id < 30)? ry3: rz3));
    ...
    sum2 += a7*((lane_id < 9 )? tx2: ((lane_id < 24)? ty2: tz2));
    sum3 += a7*((lane_id < 8 )? tx3: ((lane_id < 23)? ty3: tz3));
    sum4 += a7*((lane_id < 8 )? rx0: ((lane_id < 23)? ry0: rz0));
    sum5 += a7*((lane_id < 3 )? rx1: ((lane_id < 16)? ry1: rz1));
    sum6 += a7*((lane_id < 3 )? rx2: ((lane_id < 16)? ry2: rz2));
    sum7 += a7*((lane_id < 16)? rx3: ((lane_id < 29)? ry3: rz3));
    ...
    sum2 += a8*((lane_id < 8 )? tx2: ((lane_id < 24)? ty2: tz2));
    sum3 += a8*((lane_id < 8 )? tx3: ((lane_id < 22)? ty3: tz3));
    sum4 += a8*((lane_id < 8 )? rx0: ((lane_id < 22)? ry0: rz0));
    sum5 += a8*((lane_id < 2 )? rx1: ((lane_id < 16)? ry1: rz1));
    sum6 += a8*((lane_id < 2 )? rx2: ((lane_id < 16)? ry2: rz2));
    sum7 += a8*((lane_id < 16)? rx3: ((lane_id < 28)? ry3: rz3));
...
__global__ void Stencil_Cuda_Shfl8_2DWarp(DATA_TYPE *in, DATA_TYPE *out, DATA_TYPE a0, DATA_TYPE a1, 
        DATA_TYPE a2, DATA_TYPE a3, DATA_TYPE a4, 
        DATA_TYPE a5, DATA_TYPE a6, DATA_TYPE a7, DATA_TYPE a8,
        int m, int n, int halo) 
{
    ...
    sum2 += a0*((lane_id < 14)? tx2: ty2);
    sum3 += a0*((lane_id < 8 )? tx3: ty3);
    sum4 += a0*((lane_id < 26)? rx0: ry0);
    sum5 += a0*((lane_id < 20)? rx1: ry1);
    sum6 += a0*((lane_id < 14)? rx2: ry2);
    sum7 += a0*((lane_id < 8 )? rx3: ry3);
    ...
    sum2 += a1*((lane_id < 13)? tx2: ty2);
    sum3 += a1*((lane_id < 7 )? tx3: ty3);
    sum4 += a1*((lane_id < 25)? rx0: ry0);
    sum5 += a1*((lane_id < 19)? rx1: ry1);
    sum6 += a1*((lane_id < 13)? rx2: ry2);
    sum7 += a1*((lane_id < 7 )? rx3: ry3);
    ...
    sum2 += a2*((lane_id < 12)? tx2: ty2);
    sum3 += a2*((lane_id < 6 )? tx3: ty3);
    sum4 += a2*((lane_id < 24)? rx0: ry0);
    sum5 += a2*((lane_id < 18)? rx1: ry1);
    sum6 += a2*((lane_id < 12)? rx2: ry2);
    sum7 += a2*((lane_id < 6 )? rx3: ry3);
    ...
    sum2 += a3*((lane_id < 6 )? tx2: ty2);
    sum3 += a3*((lane_id < 24)? ty3: tz3);
    sum4 += a3*((lane_id < 18)? rx0: ry0);
    sum5 += a3*((lane_id < 12)? rx1: ry1);
    sum6 += a3*((lane_id < 6 )? rx2: ry2);
    ...
    sum2 += a5*((lane_id < 4 )? tx2: ((lane_id < 30)? ty2: tz2));
    sum3 += a5*((lane_id < 24)? ty3: tz3);
    sum4 += a5*((lane_id < 16)? rx0: ry0);
    sum5 += a5*((lane_id < 10)? rx1: ry1);
    sum6 += a5*((lane_id < 4 )? rx2: ((lane_id < 30)? ry2: rz2));
    sum7 += a5*((lane_id < 24)? ry3: rz3);
    ...
    sum2 += a6*((lane_id < 24)? ty2: tz2);
    sum3 += a6*((lane_id < 16)? ty3: tz3);
    sum4 += a6*((lane_id < 10)? rx0: ry0);
    sum5 += a6*((lane_id < 4 )? rx1: ((lane_id < 30)? ry1: rz1));
    sum6 += a6*((lane_id < 24)? ry2: rz2);
    sum7 += a6*((lane_id < 16)? ry3: rz3);
    ...
    sum2 += a7*((lane_id < 23)? ty2: tz2);
    sum3 += a7*((lane_id < 16)? ty3: tz3);
    sum4 += a7*((lane_id < 9 )? rx0: ry0);
    sum5 += a7*((lane_id < 3 )? rx1: ((lane_id < 29)? ry1: rz1));
    sum6 += a7*((lane_id < 23)? ry2: rz2);
    sum7 += a7*((lane_id < 16)? ry3: rz3);
    ...
    sum2 += a8*((lane_id < 22)? ty2: tz2);
    sum3 += a8*((lane_id < 16)? ty3: tz3);
    sum4 += a8*((lane_id < 8 )? rx0: ry0);
    sum5 += a8*((lane_id < 2 )? rx1: ((lane_id < 28)? ry1: rz1));
    sum6 += a8*((lane_id < 22)? ry2: rz2);
    sum7 += a8*((lane_id < 16)? ry3: rz3);
...
__global__ void Stencil_Cuda_Sm_Cyclic(DATA_TYPE *in, DATA_TYPE *out, DATA_TYPE a0, DATA_TYPE a1, 
        DATA_TYPE a2, DATA_TYPE a3, DATA_TYPE a4, 
        DATA_TYPE a5, DATA_TYPE a6, DATA_TYPE a7, DATA_TYPE a8,
        int m, int n, int halo) 
{
...
int main(int argc, char **argv)
{
    ...
    for(int i=0; i< ITER; i++)
    {
        Stencil_Cuda_Sm_Cyclic<<<dimGrid1, dimBlock1>>>(in_d, out_d, 
                args[0], args[1], args[2], args[3], args[4], 
                args[5], args[6], args[7], args[8],
                m, n, halo); 
        swap(in_d, out_d);
    ...
    for(int i=0; i< ITER; i++)
    {
        Stencil_Cuda_Shfl_2DWarp<<<dimGrid2, dimBlock2>>>(in_d, out_d, 
                args[0], args[1], args[2], args[3], args[4], 
                args[5], args[6], args[7], args[8],
                m, n, halo);
        swap(in_d, out_d);
    ...
    for(int i=0; i< ITER; i++)
    {
        Stencil_Cuda_Shfl2_2DWarp<<<dimGrid3, dimBlock3>>>(in_d, out_d, 
                args[0], args[1], args[2], args[3], args[4], 
                args[5], args[6], args[7], args[8],
                m, n, halo);
        swap(in_d, out_d);
    ...
    for(int i=0; i< ITER; i++)
    {
        Stencil_Cuda_Shfl4_2DWarp<<<dimGrid4, dimBlock4>>>(in_d, out_d, 
                args[0], args[1], args[2], args[3], args[4], 
                args[5], args[6], args[7], args[8],
                m, n, halo); 
        swap(in_d, out_d);
    ...
    for(int i=0; i< ITER; i++)
    {
        Stencil_Cuda_Shfl8_2DWarp<<<dimGrid5, dimBlock5>>>(in_d, out_d, 
                args[0], args[1], args[2], args[3], args[4], 
                args[5], args[6], args[7], args[8],
                m, n, halo); 
        swap(in_d, out_d);
