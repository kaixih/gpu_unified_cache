...
#define LOC_2D(_x,_y)     local[(_x)*(34)+(_y)]
...
__global__ void Stencil_Cuda_Shfl2_2DWarp(DATA_TYPE *in, DATA_TYPE *out, DATA_TYPE *args, int m, int n, int halo) 
{
    ...
    sum0 += ARG_2D(0,j  ,i)*((lane_id < 26)? tx0: ty0);
    sum1 += ARG_2D(0,j+4,i)*((lane_id < 20)? tx1: ty1);
    ...
    ty1 = __shfl(threadInput2, friend_id1);
    sum0 += ARG_2D(1,j  ,i)*((lane_id < 25)? tx0: ty0);
    sum1 += ARG_2D(1,j+4,i)*((lane_id < 19)? tx1: ty1);
    ...
    ty1 = __shfl(threadInput2, friend_id1);
    sum0 += ARG_2D(2,j  ,i)*((lane_id < 24)? tx0: ty0);
    sum1 += ARG_2D(2,j+4,i)*((lane_id < 18)? tx1: ty1);
    ...
    ty1 = __shfl(threadInput2, friend_id1);
    sum0 += ARG_2D(3,j  ,i)*((lane_id < 18)? tx0: ty0);
    sum1 += ARG_2D(3,j+4,i)*((lane_id < 12)? tx1: ty1);
    ...
    ty1 = __shfl(threadInput2, friend_id1);
    sum0 += ARG_2D(5,j  ,i)*((lane_id < 16)? tx0: ty0);
    sum1 += ARG_2D(5,j+4,i)*((lane_id < 10)? tx1: ty1);
    ...
    sum0 += ARG_2D(6,j  ,i)*((lane_id < 10)? tx0: ty0);
    sum1 += ARG_2D(6,j+4,i)*((lane_id < 4)? tx1: ((lane_id < 30)? ty1: tz1));
    ...
    tz1 = __shfl(threadInput3, friend_id1);
    sum0 += ARG_2D(7,j  ,i)*((lane_id < 9 )? tx0: ty0);
    sum1 += ARG_2D(7,j+4,i)*((lane_id < 3 )? tx1: ((lane_id < 29)? ty1: tz1));
    ...
    tz1 = __shfl(threadInput3, friend_id1);
    sum0 += ARG_2D(8,j  ,i)*((lane_id < 8)? tx0: ty0);
    sum1 += ARG_2D(8,j+4,i)*((lane_id < 2)? tx1: ((lane_id < 28)? ty1: tz1));
...
__global__ void Stencil_Cuda_Shfl4_2DWarp(DATA_TYPE *in, DATA_TYPE *out, DATA_TYPE *args, int m, int n, int halo) 
{
    ...
    sum0 += ARG_2D(0,j   ,i)*((lane_id < 26)? tx0: ty0);
    sum1 += ARG_2D(0,j+4 ,i)*((lane_id < 20)? tx1: ty1);
    sum2 += ARG_2D(0,j+8 ,i)*((lane_id < 14)? tx2: ty2);
    sum3 += ARG_2D(0,j+12,i)*((lane_id < 8 )? tx3: ty3);
    ...
    sum0 += ARG_2D(1,j   ,i)*((lane_id < 25)? tx0: ty0);
    sum1 += ARG_2D(1,j+4 ,i)*((lane_id < 19)? tx1: ty1);
    sum2 += ARG_2D(1,j+8 ,i)*((lane_id < 13)? tx2: ty2);
    sum3 += ARG_2D(1,j+12,i)*((lane_id < 7 )? tx3: ty3);
    ...
    sum0 += ARG_2D(2,j   ,i)*((lane_id < 24)? tx0: ty0);
    sum1 += ARG_2D(2,j+4 ,i)*((lane_id < 18)? tx1: ty1);
    sum2 += ARG_2D(2,j+8 ,i)*((lane_id < 12)? tx2: ty2);
    sum3 += ARG_2D(2,j+12,i)*((lane_id < 6 )? tx3: ty3);
    ...
    sum0 += ARG_2D(3,j   ,i)*((lane_id < 18)? tx0: ty0);
    sum1 += ARG_2D(3,j+4 ,i)*((lane_id < 12)? tx1: ty1);
    sum2 += ARG_2D(3,j+8 ,i)*((lane_id < 6 )? tx2: ty2);
    ...
    sum0 += ARG_2D(5,j   ,i)*((lane_id < 16)? tx0: ty0);
    sum1 += ARG_2D(5,j+4 ,i)*((lane_id < 10)? tx1: ty1);
    sum2 += ARG_2D(5,j+8 ,i)*((lane_id < 4 )? tx2: ((lane_id < 30)? ty2: tz2));
    sum3 += ARG_2D(5,j+12,i)*((lane_id < 24)? ty3: tz3);
    ...
    sum0 += ARG_2D(6,j   ,i)*((lane_id < 10)? tx0: ty0);
    sum1 += ARG_2D(6,j+4 ,i)*((lane_id < 4 )? tx1: ((lane_id < 30)? ty1: tz1));
    sum2 += ARG_2D(6,j+8 ,i)*((lane_id < 24)? ty2: tz2);
    sum3 += ARG_2D(6,j+12,i)*((lane_id < 16)? ty3: tz3);
    ...
    sum0 += ARG_2D(7,j   ,i)*((lane_id < 9 )? tx0: ty0);
    sum1 += ARG_2D(7,j+4 ,i)*((lane_id < 3 )? tx1: ((lane_id < 29)? ty1: tz1));
    sum2 += ARG_2D(7,j+8 ,i)*((lane_id < 23)? ty2: tz2);
    sum3 += ARG_2D(7,j+12,i)*((lane_id < 16)? ty3: tz3);
    ...
    sum0 += ARG_2D(8,j   ,i)*((lane_id < 8 )? tx0: ty0);
    sum1 += ARG_2D(8,j+4 ,i)*((lane_id < 2 )? tx1: ((lane_id < 28)? ty1: tz1));
    sum2 += ARG_2D(8,j+8 ,i)*((lane_id < 22)? ty2: tz2);
    sum3 += ARG_2D(8,j+12,i)*((lane_id < 16)? ty3: tz3);
...
__global__ void Stencil_Cuda_Shfl4_2(DATA_TYPE *in, DATA_TYPE *out, DATA_TYPE *args, int m, int n, int halo) 
{
    ...
    sum1 += ARG_2D(0,j  ,i+8)*((lane_id < 14)? tx1: ((lane_id < 26)? ty1: tz1));
    sum2 += ARG_2D(0,j+4,i  )*((lane_id < 14)? tx2: ((lane_id < 26)? ty2: tz2));
    ...
    sum1 += ARG_2D(1,j  ,i+8)*((lane_id < 13)? tx1: ((lane_id < 25)? ty1: tz1));
    sum2 += ARG_2D(1,j+4,i  )*((lane_id < 13)? tx2: ((lane_id < 25)? ty2: tz2));
    sum3 += ARG_2D(1,j+4,i+8)*((lane_id < 8 )? tx3: ((lane_id < 24)? ty3: tz3));
    ...
    sum1 += ARG_2D(2,j  ,i+8)*((lane_id < 12)? tx1: ((lane_id < 24)? ty1: tz1));
    sum2 += ARG_2D(2,j+4,i  )*((lane_id < 12)? tx2: ((lane_id < 24)? ty2: tz2));
    sum3 += ARG_2D(2,j+4,i+8)*((lane_id < 8 )? tx3: ((lane_id < 24)? ty3: tz3));
    ...
    sum1 += ARG_2D(3,j  ,i+8)*((lane_id < 6 )? tx1: ((lane_id < 18)? ty1: tz1));
    sum2 += ARG_2D(3,j+4,i  )*((lane_id < 6 )? tx2: ((lane_id < 18)? ty2: tz2));
    sum3 += ARG_2D(3,j+4,i+8)*((lane_id < 16)? tx3: ty3);
    ...
    sum1 += ARG_2D(5,j  ,i+8)*((lane_id < 4 )? tx1: ((lane_id < 16)? ty1: tz1));
    sum2 += ARG_2D(5,j+4,i  )*((lane_id < 4 )? tx2: ((lane_id < 16)? ty2: tz2));
    sum3 += ARG_2D(5,j+4,i+8)*((lane_id < 16)? tx3: ((lane_id < 30)? ty3: tz3));
    ...
    sum1 += ARG_2D(6,j  ,i+8)*((lane_id < 10)? tx1: ((lane_id < 24)? ty1: tz1));
    sum2 += ARG_2D(6,j+4,i  )*((lane_id < 10)? tx2: ((lane_id < 24)? ty2: tz2));
    sum3 += ARG_2D(6,j+4,i+8)*((lane_id < 8 )? tx3: ((lane_id < 24)? ty3: tz3));
    ...
    sum1 += ARG_2D(7,j  ,i+8)*((lane_id < 9 )? tx1: ((lane_id < 24)? ty1: tz1));
    sum2 += ARG_2D(7,j+4,i  )*((lane_id < 9 )? tx2: ((lane_id < 24)? ty2: tz2));
    sum3 += ARG_2D(7,j+4,i+8)*((lane_id < 8 )? tx3: ((lane_id < 23)? ty3: tz3));
    ...
    sum1 += ARG_2D(8,j  ,i+8)*((lane_id < 8 )? tx1: ((lane_id < 24)? ty1: tz1));
    sum2 += ARG_2D(8,j+4,i  )*((lane_id < 8 )? tx2: ((lane_id < 24)? ty2: tz2));
    sum3 += ARG_2D(8,j+4,i+8)*((lane_id < 8 )? tx3: ((lane_id < 22)? ty3: tz3));
...
__global__ void Stencil_Cuda_Shfl8_2(DATA_TYPE *in, DATA_TYPE *out, DATA_TYPE *args, int m, int n, int halo) 
{
    ...
    sum5 += ARG_2D(0,j+8 ,i+8)*((lane_id < 8 )? rx1: ((lane_id < 20)? ry1: rz1));
    sum6 += ARG_2D(0,j+12,i  )*((lane_id < 8 )? rx2: ((lane_id < 20)? ry2: rz2));
    ...
    sum2 += ARG_2D(1,j+4 ,i  )*((lane_id < 13)? tx2: ((lane_id < 25)? ty2: tz2));
    sum3 += ARG_2D(1,j+4 ,i+8)*((lane_id < 8 )? tx3: ((lane_id < 24)? ty3: tz3));
    sum4 += ARG_2D(1,j+8 ,i  )*((lane_id < 8 )? rx0: ((lane_id < 24)? ry0: rz0));
    sum5 += ARG_2D(1,j+8 ,i+8)*((lane_id < 7 )? rx1: ((lane_id < 19)? ry1: rz1));
    sum6 += ARG_2D(1,j+12,i  )*((lane_id < 7 )? rx2: ((lane_id < 19)? ry2: rz2));
    sum7 += ARG_2D(1,j+12,i+8)*((lane_id < 16)? rx3: ry3);
    ...
    sum2 += ARG_2D(2,j+4 ,i  )*((lane_id < 12)? tx2: ((lane_id < 24)? ty2: tz2));
    sum3 += ARG_2D(2,j+4 ,i+8)*((lane_id < 8 )? tx3: ((lane_id < 24)? ty3: tz3));
    sum4 += ARG_2D(2,j+8 ,i  )*((lane_id < 8 )? rx0: ((lane_id < 24)? ry0: rz0));
    sum5 += ARG_2D(2,j+8 ,i+8)*((lane_id < 6 )? rx1: ((lane_id < 18)? ry1: rz1));
    sum6 += ARG_2D(2,j+12,i  )*((lane_id < 6 )? rx2: ((lane_id < 18)? ry2: rz2));
    sum7 += ARG_2D(2,j+12,i+8)*((lane_id < 16)? rx3: ry3);
    ...
    sum2 += ARG_2D(3,j+4 ,i  )*((lane_id < 6 )? tx2: ((lane_id < 18)? ty2: tz2));
    sum3 += ARG_2D(3,j+4 ,i+8)*((lane_id < 16)? tx3: ty3);
    sum4 += ARG_2D(3,j+8 ,i  )*((lane_id < 16)? rx0: ry0);
    sum5 += ARG_2D(3,j+8 ,i+8)*((lane_id < 12)? rx1: ((lane_id < 24)? ry1: rz1));
    sum6 += ARG_2D(3,j+12,i  )*((lane_id < 12)? rx2: ((lane_id < 24)? ry2: rz2));
    ...
    sum2 += ARG_2D(5,j+4 ,i  )*((lane_id < 4 )? tx2: ((lane_id < 16)? ty2: tz2));
    sum3 += ARG_2D(5,j+4 ,i+8)*((lane_id < 16)? tx3: ((lane_id < 30)? ty3: tz3));
    sum4 += ARG_2D(5,j+8 ,i  )*((lane_id < 16)? rx0: ((lane_id < 30)? ry0: rz0));
    sum5 += ARG_2D(5,j+8 ,i+8)*((lane_id < 10)? rx1: ((lane_id < 24)? ry1: rz1));
    sum6 += ARG_2D(5,j+12,i  )*((lane_id < 10)? rx2: ((lane_id < 24)? ry2: rz2));
    sum7 += ARG_2D(5,j+12,i+8)*((lane_id < 8 )? rx3: ((lane_id < 24)? ry3: rz3));
    ...
    sum2 += ARG_2D(6,j+4 ,i  )*((lane_id < 10)? tx2: ((lane_id < 24)? ty2: tz2));
    sum3 += ARG_2D(6,j+4 ,i+8)*((lane_id < 8 )? tx3: ((lane_id < 24)? ty3: tz3));
    sum4 += ARG_2D(6,j+8 ,i  )*((lane_id < 8 )? rx0: ((lane_id < 24)? ry0: rz0));
    sum5 += ARG_2D(6,j+8 ,i+8)*((lane_id < 4 )? rx1: ((lane_id < 16)? ry1: rz1));
    sum6 += ARG_2D(6,j+12,i  )*((lane_id < 4 )? rx2: ((lane_id < 16)? ry2: rz2));
    sum7 += ARG_2D(6,j+12,i+8)*((lane_id < 16)? rx3: ((lane_id < 30)? ry3: rz3));
    ...
    sum2 += ARG_2D(7,j+4 ,i  )*((lane_id < 9 )? tx2: ((lane_id < 24)? ty2: tz2));
    sum3 += ARG_2D(7,j+4 ,i+8)*((lane_id < 8 )? tx3: ((lane_id < 23)? ty3: tz3));
    sum4 += ARG_2D(7,j+8 ,i  )*((lane_id < 8 )? rx0: ((lane_id < 23)? ry0: rz0));
    sum5 += ARG_2D(7,j+8 ,i+8)*((lane_id < 3 )? rx1: ((lane_id < 16)? ry1: rz1));
    sum6 += ARG_2D(7,j+12,i  )*((lane_id < 3 )? rx2: ((lane_id < 16)? ry2: rz2));
    sum7 += ARG_2D(7,j+12,i+8)*((lane_id < 16)? rx3: ((lane_id < 29)? ry3: rz3));
    ...
    sum2 += ARG_2D(8,j+4 ,i  )*((lane_id < 8 )? tx2: ((lane_id < 24)? ty2: tz2));
    sum3 += ARG_2D(8,j+4 ,i+8)*((lane_id < 8 )? tx3: ((lane_id < 22)? ty3: tz3));
    sum4 += ARG_2D(8,j+8 ,i  )*((lane_id < 8 )? rx0: ((lane_id < 22)? ry0: rz0));
    sum5 += ARG_2D(8,j+8 ,i+8)*((lane_id < 2 )? rx1: ((lane_id < 16)? ry1: rz1));
    sum6 += ARG_2D(8,j+12,i  )*((lane_id < 2 )? rx2: ((lane_id < 16)? ry2: rz2));
    sum7 += ARG_2D(8,j+12,i+8)*((lane_id < 16)? rx3: ((lane_id < 28)? ry3: rz3));
...
__global__ void Stencil_Cuda_Shfl8_2DWarp(DATA_TYPE *in, DATA_TYPE *out, DATA_TYPE *args, int m, int n, int halo) 
{
    ...
    sum2 += ARG_2D(0,j+8 ,i)*((lane_id < 14)? tx2: ty2);
    sum3 += ARG_2D(0,j+12,i)*((lane_id < 8 )? tx3: ty3);
    sum4 += ARG_2D(0,j+16,i)*((lane_id < 26)? rx0: ry0);
    sum5 += ARG_2D(0,j+20,i)*((lane_id < 20)? rx1: ry1);
    sum6 += ARG_2D(0,j+24,i)*((lane_id < 14)? rx2: ry2);
    sum7 += ARG_2D(0,j+28,i)*((lane_id < 8 )? rx3: ry3);
    ...
    sum2 += ARG_2D(1,j+8 ,i)*((lane_id < 13)? tx2: ty2);
    sum3 += ARG_2D(1,j+12,i)*((lane_id < 7 )? tx3: ty3);
    sum4 += ARG_2D(1,j+16,i)*((lane_id < 25)? rx0: ry0);
    sum5 += ARG_2D(1,j+20,i)*((lane_id < 19)? rx1: ry1);
    sum6 += ARG_2D(1,j+24,i)*((lane_id < 13)? rx2: ry2);
    sum7 += ARG_2D(1,j+28,i)*((lane_id < 7 )? rx3: ry3);
    ...
    sum2 += ARG_2D(2,j+8 ,i)*((lane_id < 12)? tx2: ty2);
    sum3 += ARG_2D(2,j+12,i)*((lane_id < 6 )? tx3: ty3);
    sum4 += ARG_2D(2,j+16,i)*((lane_id < 24)? rx0: ry0);
    sum5 += ARG_2D(2,j+20,i)*((lane_id < 18)? rx1: ry1);
    sum6 += ARG_2D(2,j+24,i)*((lane_id < 12)? rx2: ry2);
    sum7 += ARG_2D(2,j+28,i)*((lane_id < 6 )? rx3: ry3);
    ...
    sum2 += ARG_2D(3,j+8 ,i)*((lane_id < 6 )? tx2: ty2);
    sum3 += ARG_2D(3,j+12,i)*((lane_id < 24)? ty3: tz3);
    sum4 += ARG_2D(3,j+16,i)*((lane_id < 18)? rx0: ry0);
    sum5 += ARG_2D(3,j+20,i)*((lane_id < 12)? rx1: ry1);
    sum6 += ARG_2D(3,j+24,i)*((lane_id < 6 )? rx2: ry2);
    ...
    sum2 += ARG_2D(5,j+8 ,i)*((lane_id < 4 )? tx2: ((lane_id < 30)? ty2: tz2));
    sum3 += ARG_2D(5,j+12,i)*((lane_id < 24)? ty3: tz3);
    sum4 += ARG_2D(5,j+16,i)*((lane_id < 16)? rx0: ry0);
    sum5 += ARG_2D(5,j+20,i)*((lane_id < 10)? rx1: ry1);
    sum6 += ARG_2D(5,j+24,i)*((lane_id < 4 )? rx2: ((lane_id < 30)? ry2: rz2));
    sum7 += ARG_2D(5,j+28,i)*((lane_id < 24)? ry3: rz3);
    ...
    sum2 += ARG_2D(6,j+8 ,i)*((lane_id < 24)? ty2: tz2);
    sum3 += ARG_2D(6,j+12,i)*((lane_id < 16)? ty3: tz3);
    sum4 += ARG_2D(6,j+16,i)*((lane_id < 10)? rx0: ry0);
    sum5 += ARG_2D(6,j+20,i)*((lane_id < 4 )? rx1: ((lane_id < 30)? ry1: rz1));
    sum6 += ARG_2D(6,j+24,i)*((lane_id < 24)? ry2: rz2);
    sum7 += ARG_2D(6,j+28,i)*((lane_id < 16)? ry3: rz3);
    ...
    sum2 += ARG_2D(7,j+8 ,i)*((lane_id < 23)? ty2: tz2);
    sum3 += ARG_2D(7,j+12,i)*((lane_id < 16)? ty3: tz3);
    sum4 += ARG_2D(7,j+16,i)*((lane_id < 9 )? rx0: ry0);
    sum5 += ARG_2D(7,j+20,i)*((lane_id < 3 )? rx1: ((lane_id < 29)? ry1: rz1));
    sum6 += ARG_2D(7,j+24,i)*((lane_id < 23)? ry2: rz2);
    sum7 += ARG_2D(7,j+28,i)*((lane_id < 16)? ry3: rz3);
    ...
    sum2 += ARG_2D(8,j+8 ,i)*((lane_id < 22)? ty2: tz2);
    sum3 += ARG_2D(8,j+12,i)*((lane_id < 16)? ty3: tz3);
    sum4 += ARG_2D(8,j+16,i)*((lane_id < 8 )? rx0: ry0);
    sum5 += ARG_2D(8,j+20,i)*((lane_id < 2 )? rx1: ((lane_id < 28)? ry1: rz1));
    sum6 += ARG_2D(8,j+24,i)*((lane_id < 22)? ry2: rz2);
    sum7 += ARG_2D(8,j+28,i)*((lane_id < 16)? ry3: rz3);
...
{
    __shared__ DATA_TYPE local[34*10];
    int i = threadIdx.x + blockIdx.x * blockDim.x + halo; 
    int j = threadIdx.y + blockIdx.y * blockDim.y + halo; 
    int li = threadIdx.x + halo;
    int lj = threadIdx.y + halo;
        ...
        int m, int n, int halo) 
{
    ...
    tx0 = __shfl(reg1, friend_id0);
    ty0 = __shfl(reg2, friend_id0);
    sum0 += ARG_2D(5,j,i)*((lane_id < 28)? tx0: ty0);
        
    friend_id0 = (lane_id+4 )&(warpSize-1);
    tx0 = __shfl(reg2, friend_id0);
    ty0 = __shfl(reg3, friend_id0);
    sum0 += ARG_2D(6,j,i)*((lane_id < 28)? tx0: ty0);

    friend_id0 = (lane_id+5 )&(warpSize-1);
    tx0 = __shfl(reg2, friend_id0);
    ty0 = __shfl(reg3, friend_id0);
    sum0 += ARG_2D(7,j,i)*((lane_id < 27)? tx0: ty0);

    friend_id0 = (lane_id+6 )&(warpSize-1);
    tx0 = __shfl(reg2, friend_id0);
    ty0 = __shfl(reg3, friend_id0);
    sum0 += ARG_2D(8,j,i)*((lane_id < 26)? tx0: ty0);
        ...
        int m, int n, int halo) 
{
    ...
    sum0 += ARG_2D(0,j  ,i)*tx0;
    sum1 += ARG_2D(0,j+1,i)*((lane_id < 30)? tx1: ty1);
    ...
    ty1 = __shfl(reg2, friend_id1);
    sum0 += ARG_2D(1,j  ,i)*((lane_id < 31)? tx0: ty0);
    sum1 += ARG_2D(1,j+1,i)*((lane_id < 29)? tx1: ty1);
    ...
    ty1 = __shfl(reg2, friend_id1);
    sum0 += ARG_2D(2,j  ,i)*((lane_id < 30)? tx0: ty0);
    sum1 += ARG_2D(2,j+1,i)*((lane_id < 28)? tx1: ty1);
    ...
    sum0 += ARG_2D(3,j  ,i)*((lane_id < 30)? tx0: ty0);
    sum1 += ARG_2D(3,j+1,i)*((lane_id < 28)? tx1: ty1);
    ...
    ty1 = __shfl(reg3, friend_id1);
    sum0 += ARG_2D(5,j  ,i)*((lane_id < 28)? tx0: ty0);
    sum1 += ARG_2D(5,j+1,i)*((lane_id < 26)? tx1: ty1);
    ...
    sum0 += ARG_2D(6,j  ,i)*((lane_id < 28)? tx0: ty0);
    sum1 += ARG_2D(6,j+1,i)*((lane_id < 26)? tx1: ty1);
    ...
    ty1 = __shfl(reg4, friend_id1);
    sum0 += ARG_2D(7,j  ,i)*((lane_id < 27)? tx0: ty0);
    sum1 += ARG_2D(7,j+1,i)*((lane_id < 25)? tx1: ty1);
    ...
    ty1 = __shfl(reg4, friend_id1);
    sum0 += ARG_2D(8,j  ,i)*((lane_id < 26)? tx0: ty0);
    sum1 += ARG_2D(8,j+1,i)*((lane_id < 24)? tx1: ty1);
        ...
        int m, int n, int halo) 
{
    ...
    sum0 += ARG_2D(0,j  ,i)*tx0;
    sum1 += ARG_2D(0,j+1,i)*((lane_id < 30)? tx1: ty1);
    sum2 += ARG_2D(0,j+2,i)*((lane_id < 28)? tx2: ty2);
    sum3 += ARG_2D(0,j+3,i)*((lane_id < 26)? tx3: ty3);
    ...
    sum0 += ARG_2D(1,j  ,i)*((lane_id < 31)? tx0: ty0);
    sum1 += ARG_2D(1,j+1,i)*((lane_id < 29)? tx1: ty1);
    sum2 += ARG_2D(1,j+2,i)*((lane_id < 27)? tx2: ty2);
    sum3 += ARG_2D(1,j+3,i)*((lane_id < 25)? tx3: ty3);
    ...
    sum0 += ARG_2D(2,j  ,i)*((lane_id < 30)? tx0: ty0);
    sum1 += ARG_2D(2,j+1,i)*((lane_id < 28)? tx1: ty1);
    sum2 += ARG_2D(2,j+2,i)*((lane_id < 26)? tx2: ty2);
    sum3 += ARG_2D(2,j+3,i)*((lane_id < 24)? tx3: ty3);
    ...
    sum0 += ARG_2D(3,j  ,i)*((lane_id < 30)? tx0: ty0);
    sum1 += ARG_2D(3,j+1,i)*((lane_id < 28)? tx1: ty1);
    sum2 += ARG_2D(3,j+2,i)*((lane_id < 26)? tx2: ty2);
    sum3 += ARG_2D(3,j+3,i)*((lane_id < 24)? tx3: ty3);
    ...
    sum0 += ARG_2D(5,j  ,i)*((lane_id < 28)? tx0: ty0);
    sum1 += ARG_2D(5,j+1,i)*((lane_id < 26)? tx1: ty1);
    sum2 += ARG_2D(5,j+2,i)*((lane_id < 24)? tx2: ty2);
    sum3 += ARG_2D(5,j+3,i)*((lane_id < 22)? tx3: ty3);
    ...
    sum0 += ARG_2D(6,j  ,i)*((lane_id < 28)? tx0: ty0);
    sum1 += ARG_2D(6,j+1,i)*((lane_id < 26)? tx1: ty1);
    sum2 += ARG_2D(6,j+2,i)*((lane_id < 24)? tx2: ty2);
    sum3 += ARG_2D(6,j+3,i)*((lane_id < 22)? tx3: ty3);
    ...
    sum0 += ARG_2D(7,j  ,i)*((lane_id < 27)? tx0: ty0);
    sum1 += ARG_2D(7,j+1,i)*((lane_id < 25)? tx1: ty1);
    sum2 += ARG_2D(7,j+2,i)*((lane_id < 23)? tx2: ty2);
    sum3 += ARG_2D(7,j+3,i)*((lane_id < 21)? tx3: ty3);
    ...
    sum0 += ARG_2D(8,j  ,i)*((lane_id < 26)? tx0: ty0);
    sum1 += ARG_2D(8,j+1,i)*((lane_id < 24)? tx1: ty1);
    sum2 += ARG_2D(8,j+2,i)*((lane_id < 22)? tx2: ty2);
    sum3 += ARG_2D(8,j+3,i)*((lane_id < 20)? tx3: ty3);
...
int main(int argc, char **argv)
{
...
#ifdef __DEBUG
    Init_Args_2D(args, 9, m, n, halo, 1.0);
#else
    Init_Args_2D(args, 9, m, n, halo, 0.11);
#endif
    ...
    printf("Throughput   : %.3f (GB/s)\n", GetThroughput(ARGC_2D9, 1, m+2*halo, n+2*halo, ITER, time_wo_pci, sizeof(DATA_TYPE)));
    ...
    dim3 dimGrid11((n)/32, (m)/8, 1);
    dim3 dimBlock11(32, 8, 1);
    cudaEventRecord(start);
    for(int i=0; i< ITER; i++)
    {
        Stencil_Cuda_Sm_Branch<<<dimGrid11, dimBlock11>>>(in_d, out_d, 
                args_d,
                m, n, halo); 
        swap(in_d, out_d);
    }
    ...
    dim3 dimGrid1((n)/32, (m)/8, 1);
    dim3 dimBlock1(32, 8, 1);
    cudaEventRecord(start);
    for(int i=0; i< ITER; i++)
    {
        Stencil_Cuda_Sm_Cyclic<<<dimGrid1, dimBlock1>>>(in_d, out_d, args_d, m, n, halo);
        swap(in_d, out_d);
    }
    swap(in_d, out_d);
    cudaEventRecord(stop);
    ...
    */
    ...
    dim3 dimGrid8((n)/32, (m)/8, 1);
    dim3 dimBlock8(32, 8, 1);
    cudaEventRecord(start);
    for(int i=0; i< ITER; i++)
    {
        Stencil_Cuda_Shfl_1DWarp<<<dimGrid8, dimBlock8>>>(in_d, out_d, 
                args_d,
                m, n, halo);
        swap(in_d, out_d);
    }
    ...
    dim3 dimGrid9((n)/32, (m)/(8*2), 1);
    dim3 dimBlock9(32, 8, 1);
    cudaEventRecord(start);
    for(int i=0; i< ITER; i++)
    {
        Stencil_Cuda_Shfl2_1DWarp<<<dimGrid9, dimBlock9>>>(in_d, out_d, 
                args_d,
                m, n, halo);
        swap(in_d, out_d);
    }
    ...
    dim3 dimGrid10((n)/32, (m)/(8*4), 1);
    dim3 dimBlock10(32, 8, 1);
    cudaEventRecord(start);
    for(int i=0; i< ITER; i++)
    {
        Stencil_Cuda_Shfl4_1DWarp<<<dimGrid10, dimBlock10>>>(in_d, out_d, 
                args_d,
                m, n, halo);
        swap(in_d, out_d);
    }
