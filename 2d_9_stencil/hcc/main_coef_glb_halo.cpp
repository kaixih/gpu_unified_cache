        ...
        int m, int n, int halo)
{
    ...
    completion_future fut = parallel_for_each(comp_tile, [=, &in, &out, &args](tiled_index<2> tidx) restrict(amp) {
        ...
        int m, int n, int halo)
{
    ...
    completion_future fut = parallel_for_each(comp_tile, [=, &in, &out, &args](tiled_index<2> tidx) restrict(amp) {
        ...
        sum0 +=ARG_2D(1,j,i)*((lane_id < 63)? tx0: ty0);
        
        friend_id0 = (lane_id+2 )&(warpSize-1);
        tx0 = __shfl(reg0, friend_id0);
        ty0 = __shfl(reg1, friend_id0);
        sum0 +=ARG_2D(2,j,i)*((lane_id < 62)? tx0: ty0);
       
        friend_id0 = (lane_id+2 )&(warpSize-1);
        tx0 = __shfl(reg1, friend_id0);
        ty0 = __shfl(reg2, friend_id0);
        sum0 +=ARG_2D(3,j,i)*((lane_id < 62)? tx0: ty0);
        
        friend_id0 = (lane_id+3 )&(warpSize-1);
        tx0 = __shfl(reg1, friend_id0);
        ty0 = __shfl(reg2, friend_id0);
        sum0 +=ARG_2D(4,j,i)*((lane_id < 61)? tx0: ty0);
      
        friend_id0 = (lane_id+4 )&(warpSize-1);
        tx0 = __shfl(reg1, friend_id0);
        ty0 = __shfl(reg2, friend_id0);
        sum0 +=ARG_2D(5,j,i)*((lane_id < 60)? tx0: ty0);
     
        friend_id0 = (lane_id+4 )&(warpSize-1);
        tx0 = __shfl(reg2, friend_id0);
        ty0 = __shfl(reg3, friend_id0);
        sum0 +=ARG_2D(6,j,i)*((lane_id < 60)? tx0: ty0);

        friend_id0 = (lane_id+5 )&(warpSize-1);
        tx0 = __shfl(reg2, friend_id0);
        ty0 = __shfl(reg3, friend_id0);
        sum0 +=ARG_2D(7,j,i)*((lane_id < 59)? tx0: ty0);

        friend_id0 = (lane_id+6 )&(warpSize-1);
        tx0 = __shfl(reg2, friend_id0);
        ty0 = __shfl(reg3, friend_id0);
        sum0 +=ARG_2D(8,j,i)*((lane_id < 58)? tx0: ty0);
        ...
        int m, int n, int halo)
{
    ...
    completion_future fut = parallel_for_each(comp_tile, [=, &in, &out, &args](tiled_index<2> tidx) restrict(amp) {
        ...
        sum0 +=ARG_2D(0,j  ,i)*tx0;
        sum1 +=ARG_2D(0,j+1,i)*((lane_id < 62)? tx1: ty1);
        ...
        ty1 = __shfl(reg2, friend_id1);
        sum0 +=ARG_2D(1,j  ,i)*((lane_id < 63)? tx0: ty0);
        sum1 +=ARG_2D(1,j+1,i)*((lane_id < 61)? tx1: ty1);
        ...
        ty1 = __shfl(reg2, friend_id1);
        sum0 +=ARG_2D(2,j  ,i)*((lane_id < 62)? tx0: ty0);
        sum1 +=ARG_2D(2,j+1,i)*((lane_id < 60)? tx1: ty1);
        ...
        sum0 +=ARG_2D(3,j  ,i)*((lane_id < 62)? tx0: ty0);
        sum1 +=ARG_2D(3,j+1,i)*((lane_id < 60)? tx1: ty1);
        ...
        ty1 = __shfl(reg3, friend_id1);
        sum0 +=ARG_2D(4,j  ,i)*((lane_id < 61)? tx0: ty0);
        sum1 +=ARG_2D(4,j+1,i)*((lane_id < 59)? tx1: ty1);
        ...
        ty1 = __shfl(reg3, friend_id1);
        sum0 +=ARG_2D(5,j  ,i)*((lane_id < 60)? tx0: ty0);
        sum1 +=ARG_2D(5,j+1,i)*((lane_id < 58)? tx1: ty1);
        ...
        sum0 +=ARG_2D(6,j  ,i)*((lane_id < 60)? tx0: ty0);
        sum1 +=ARG_2D(6,j+1,i)*((lane_id < 58)? tx1: ty1);
        ...
        ty1 = __shfl(reg4, friend_id1);
        sum0 +=ARG_2D(7,j  ,i)*((lane_id < 59)? tx0: ty0);
        sum1 +=ARG_2D(7,j+1,i)*((lane_id < 57)? tx1: ty1);
        ...
        ty1 = __shfl(reg4, friend_id1);
        sum0 +=ARG_2D(8,j  ,i)*((lane_id < 58)? tx0: ty0);
        sum1 +=ARG_2D(8,j+1,i)*((lane_id < 56)? tx1: ty1);
        ...
        int m, int n, int halo)
{
    ...
    completion_future fut = parallel_for_each(comp_tile, [=, &in, &out, &args](tiled_index<2> tidx) restrict(amp) {
        ...
        sum0 +=ARG_2D(0,j  ,i)*tx0;
        sum1 +=ARG_2D(0,j+1,i)*((lane_id < 62)? tx1: ty1);
        sum2 +=ARG_2D(0,j+2,i)*((lane_id < 60)? tx2: ty2);
        sum3 +=ARG_2D(0,j+3,i)*((lane_id < 58)? tx3: ty3);
        ...
        sum0 +=ARG_2D(1,j  ,i)*((lane_id < 63)? tx0: ty0);
        sum1 +=ARG_2D(1,j+1,i)*((lane_id < 61)? tx1: ty1);
        sum2 +=ARG_2D(1,j+2,i)*((lane_id < 59)? tx2: ty2);
        sum3 +=ARG_2D(1,j+3,i)*((lane_id < 57)? tx3: ty3);
        ...
        sum0 +=ARG_2D(2,j  ,i)*((lane_id < 62)? tx0: ty0);
        sum1 +=ARG_2D(2,j+1,i)*((lane_id < 60)? tx1: ty1);
        sum2 +=ARG_2D(2,j+2,i)*((lane_id < 58)? tx2: ty2);
        sum3 +=ARG_2D(2,j+3,i)*((lane_id < 56)? tx3: ty3);
        ...
        sum0 +=ARG_2D(3,j  ,i)*((lane_id < 62)? tx0: ty0);
        sum1 +=ARG_2D(3,j+1,i)*((lane_id < 60)? tx1: ty1);
        sum2 +=ARG_2D(3,j+2,i)*((lane_id < 58)? tx2: ty2);
        sum3 +=ARG_2D(3,j+3,i)*((lane_id < 56)? tx3: ty3);
        ...
        sum0 +=ARG_2D(4,j  ,i)*((lane_id < 61)? tx0: ty0);
        sum1 +=ARG_2D(4,j+1,i)*((lane_id < 59)? tx1: ty1);
        sum2 +=ARG_2D(4,j+2,i)*((lane_id < 57)? tx2: ty2);
        sum3 +=ARG_2D(4,j+3,i)*((lane_id < 55)? tx3: ty3);
        ...
        sum0 +=ARG_2D(5,j  ,i)*((lane_id < 60)? tx0: ty0);
        sum1 +=ARG_2D(5,j+1,i)*((lane_id < 58)? tx1: ty1);
        sum2 +=ARG_2D(5,j+2,i)*((lane_id < 56)? tx2: ty2);
        sum3 +=ARG_2D(5,j+3,i)*((lane_id < 54)? tx3: ty3);
        ...
        sum0 +=ARG_2D(6,j  ,i)*((lane_id < 60)? tx0: ty0);
        sum1 +=ARG_2D(6,j+1,i)*((lane_id < 58)? tx1: ty1);
        sum2 +=ARG_2D(6,j+2,i)*((lane_id < 56)? tx2: ty2);
        sum3 +=ARG_2D(6,j+3,i)*((lane_id < 54)? tx3: ty3);
        ...
        sum0 +=ARG_2D(7,j  ,i)*((lane_id < 59)? tx0: ty0);
        sum1 +=ARG_2D(7,j+1,i)*((lane_id < 57)? tx1: ty1);
        sum2 +=ARG_2D(7,j+2,i)*((lane_id < 55)? tx2: ty2);
        sum3 +=ARG_2D(7,j+3,i)*((lane_id < 53)? tx3: ty3);
        ...
        sum0 +=ARG_2D(8,j  ,i)*((lane_id < 58)? tx0: ty0);
        sum1 +=ARG_2D(8,j+1,i)*((lane_id < 56)? tx1: ty1);
        sum2 +=ARG_2D(8,j+2,i)*((lane_id < 54)? tx2: ty2);
        sum3 +=ARG_2D(8,j+3,i)*((lane_id < 52)? tx3: ty3);
