...
__global__ void Stencil_Cuda_Sweep_Sm_Branch(DATA_TYPE *in, DATA_TYPE *out, DATA_TYPE a0, DATA_TYPE a1, 
        DATA_TYPE a2, DATA_TYPE a3, DATA_TYPE a4, DATA_TYPE a5, DATA_TYPE a6, 
        int z, int m, int n, int halo)
{
    int i = threadIdx.x + blockIdx.x * blockDim.x + halo;
...
__global__ void Stencil_Cuda_Sweep_Sm_Cyclic(DATA_TYPE *in, DATA_TYPE *out, DATA_TYPE a0, DATA_TYPE a1, 
        DATA_TYPE a2, DATA_TYPE a3, DATA_TYPE a4, DATA_TYPE a5, DATA_TYPE a6, 
        int z, int m, int n, int halo)
{
    int i = threadIdx.x + blockIdx.x * blockDim.x + halo;
        ...
        int z, int m, int n, int halo)
{
    ...
    sum2 += a0*((lane_id < 24)? tx2: ty2);
    sum3 += a0*((lane_id < 1 )? tx3: ((lane_id < 27)? ty3: tz3));
    sum4 += a0*((lane_id < 5 )? rx0: ((lane_id < 31)? ry0: rz0));
    sum5 += a0*((lane_id < 8 )? rx1: ry1);
    sum6 += a0*((lane_id < 11)? rx2: ry2);
    sum7 += a0*((lane_id < 15)? rx3: ry3);
    ...
    sum6 += a1*((lane_id < 23)? rx2: ry2);
    sum7 += a1*((lane_id < 25)? rx3: ry3);
    ...
    sum2 += a2*((lane_id < 2 )? tx2: ((lane_id < 28)? ty2: tz2));
    sum3 += a2*((lane_id < 6 )? tx3: ty3);
    sum4 += a2*((lane_id < 8 )? rx0: ry0);
    sum5 += a2*((lane_id < 12)? rx1: ry1);
    sum6 += a2*((lane_id < 16)? rx2: ry2);
    sum7 += a2*((lane_id < 18)? rx3: ry3);
    ...
    sum2 += a3*((lane_id < 1 )? tx2: ((lane_id < 27)? ty2: tz2));
    sum3 += a3*((lane_id < 5 )? tx3: ((lane_id < 31)? ty3: tz3));
    sum4 += a3*((lane_id < 8 )? rx0: ry0);
    sum5 += a3*((lane_id < 11)? rx1: ry1);
    sum6 += a3*((lane_id < 15)? rx2: ry2);
    sum7 += a3*((lane_id < 17)? rx3: ry3);
    ...
    sum2 += a4*((lane_id < 26)? tx2: ty2);
    sum3 += a4*((lane_id < 4 )? tx3: ((lane_id < 30)? ty3: tz3));
    sum4 += a4*((lane_id < 8 )? rx0: ry0);
    sum5 += a4*((lane_id < 10)? rx1: ry1);
    sum6 += a4*((lane_id < 14)? rx2: ry2);
    sum7 += a4*((lane_id < 16)? rx3: ry3);
    ...
    sum2 += a5*((lane_id < 19)? tx2: ty2);
    sum3 += a5*((lane_id < 23)? tx3: ty3);
    sum4 += a5*((lane_id < 25)? rx0: ry0);
    sum5 += a5*((lane_id < 3 )? rx1: ((lane_id < 29)? ry1: rz1));
    sum6 += a5*((lane_id < 7 )? rx2: ry2);
    sum7 += a5*((lane_id < 9 )? rx3: ry3);
    ...
    sum2 += a6*((lane_id < 5 )? tx2: ((lane_id < 31)? ty2: tz2));
    sum3 += a6*((lane_id < 8 )? tx3: ty3);
    sum4 += a6*((lane_id < 11)? rx0: ry0);
    sum5 += a6*((lane_id < 15)? rx1: ry1);
    sum6 += a6*((lane_id < 17)? rx2: ry2);
    sum7 += a6*((lane_id < 21)? rx3: ry3);
...
__global__ void Stencil_Cuda_Sweep_Shfl_2DWarp(DATA_TYPE *in, DATA_TYPE *out, DATA_TYPE a0, DATA_TYPE a1, 
        DATA_TYPE a2, DATA_TYPE a3, DATA_TYPE a4, DATA_TYPE a5, DATA_TYPE a6, 
        int z, int m, int n, int halo)
{
    int i = threadIdx.x + blockIdx.x * blockDim.x + halo;
...
#pragma unroll // it seems the loop-unroll is useless to performance
    for(; k < k_end; ++k)
    {
        ...
        tx = __shfl(t2_threadInput0, friend_id);
        ty = __shfl(t2_threadInput1, friend_id);
        sum += a2*((lane_id < 18)? tx: ty);
        friend_id = (lane_id+12+((lane_id>>3)<<1))&(warpSize-1);
        tx = __shfl(t2_threadInput0, friend_id);
        ty = __shfl(t2_threadInput1, friend_id);
        sum += a4*((lane_id < 16)? tx: ty);
        friend_id = (lane_id+21+((lane_id>>3)<<1))&(warpSize-1);
        tx = __shfl(t2_threadInput0, friend_id);
        ty = __shfl(t2_threadInput1, friend_id);
        sum += a5*((lane_id < 9 )? tx: ty);

        OUT_3D(k,j,i) = sum;
    }
}

__global__ void Stencil_Cuda_Sweep_Shfl2_2DWarp(DATA_TYPE *in, DATA_TYPE *out, DATA_TYPE a0, DATA_TYPE a1, 
        DATA_TYPE a2, DATA_TYPE a3, DATA_TYPE a4, DATA_TYPE a5, DATA_TYPE a6, 
        int z, int m, int n, int halo)
{
    int tid = threadIdx.x + threadIdx.y * blockDim.x;
...
#pragma unroll // it seems the loop-unroll is useless to performance
    for(; k < k_end; ++k)
    {
        ...
        sum0 += a3*((lane_id < 17)? tx0: ty0);
        sum1 += a3*((lane_id < 11)? tx1: ty1);
        ...
        sum0 += a6*((lane_id < 17)? tx0: ty0);
        sum1 += a6*((lane_id < 11)? tx1: ty1);
        ...
        tx1 = __shfl(t2_threadInput1, friend_id1);
        ty1 = __shfl(t2_threadInput2, friend_id1);
        sum0 += a2*((lane_id < 18)? tx0: ty0);
        sum1 += a2*((lane_id < 12)? tx1: ty1);
        ...
        tx1 = __shfl(t2_threadInput1, friend_id1);
        ty1 = __shfl(t2_threadInput2, friend_id1);
        sum0 += a4*((lane_id < 16)? tx0: ty0);
        sum1 += a4*((lane_id < 10)? tx1: ty1);
        ...
        sum0 += a5*((lane_id < 9 )? tx0: ty0);
        sum1 += a5*((lane_id < 3 )? tx1: ((lane_id < 29)? ty1: tz1));
...
__global__ void Stencil_Cuda_Sweep_Shfl4_2DWarp(DATA_TYPE *in, DATA_TYPE *out, DATA_TYPE a0, DATA_TYPE a1, 
        DATA_TYPE a2, DATA_TYPE a3, DATA_TYPE a4, DATA_TYPE a5, DATA_TYPE a6, 
        int z, int m, int n, int halo)
{
    int tid = threadIdx.x + threadIdx.y * blockDim.x;
...
#pragma unroll // it seems the loop-unroll is useless to performance
    for(; k < k_end; ++k)
    {
        ...
        sum0 += a0*((lane_id < 17)? tx0: ty0);
        sum1 += a0*((lane_id < 11)? tx1: ty1);
        sum2 += a0*((lane_id < 5 )? tx2: ((lane_id < 31)? ty2: tz2));
        sum3 += a0*((lane_id < 24)? tx3: ty3);
        tx0 = __shfl(t2_threadInput0, friend_id0);
        ty0 = __shfl(t2_threadInput1, friend_id0);
        tx1 = __shfl(t2_threadInput1, friend_id1);
        ty1 = __shfl(t2_threadInput2, friend_id1);
        ...
        sum0 += a3*((lane_id < 17)? tx0: ty0);
        sum1 += a3*((lane_id < 11)? tx1: ty1);
        sum2 += a3*((lane_id < 5 )? tx2: ((lane_id < 31)? ty2: tz2));
        ...
        sum0 += a4*((lane_id < 16)? tx0: ty0);
        sum1 += a4*((lane_id < 10)? tx1: ty1);
        sum2 += a4*((lane_id < 4 )? tx2: ((lane_id < 30)? ty2: tz2));
...
int main(int argc, char **argv)
{
    ...
    for(int i =0; i< ITER; i++)
    {
        Stencil_Cuda_Shfl8_2DWarp<<<dimGrid7, dimBlock7>>>(
            in_d, out_d, args[0], args[1], args[2], args[3], args[4], args[5], args[6], z, m, n, halo);
        swap(in_d, out_d);
    }
    swap(in_d, out_d);
    cudaEventRecord(stop);
