...
#pragma unroll // it seems the loop-unroll is useless to performance
    for(; k < k_end; ++k)
    {
        ...
        sum0 += ARG_3D(0,k,j,i)*((lane_id < 29)? tx0: ty0);
        tx0 = __shfl(t2_reg1, friend_id0);
        ty0 = __shfl(t2_reg2, friend_id0);
        sum0 += ARG_3D(3,k,j,i)*((lane_id < 29)? tx0: ty0);
        tx0 = __shfl(t3_reg1, friend_id0);
        ty0 = __shfl(t3_reg2, friend_id0);
        sum0 += ARG_3D(6,k,j,i)*((lane_id < 29)? tx0: ty0);

        friend_id0 = (lane_id+4 )&(warpSize-1);
        tx0 = __shfl(t2_reg1, friend_id0);
        ty0 = __shfl(t2_reg2, friend_id0);
        sum0 += ARG_3D(4,k,j,i)*((lane_id < 28)? tx0: ty0);

        friend_id0 = (lane_id+5 )&(warpSize-1);
        tx0 = __shfl(t2_reg2, friend_id0);
        ty0 = __shfl(t2_reg3, friend_id0);
        sum0 += ARG_3D(5,k,j,i)*((lane_id < 27)? tx0: ty0);
...
#pragma unroll // it seems the loop-unroll is useless to performance
    for(; k < k_end; ++k)
    {
        ...
        sum0 += ARG_3D(0,k,j  ,i)*((lane_id < 29)? tx0: ty0);
        sum1 += ARG_3D(0,k,j+1,i)*((lane_id < 27)? tx1: ty1);
        tx0 = __shfl(t2_reg1, friend_id0);
        ty0 = __shfl(t2_reg2, friend_id0);
        tx1 = __shfl(t2_reg2, friend_id1);
        ty1 = __shfl(t2_reg3, friend_id1);
        sum0 += ARG_3D(3,k,j  ,i)*((lane_id < 29)? tx0: ty0);
        sum1 += ARG_3D(3,k,j+1,i)*((lane_id < 27)? tx1: ty1);
        tx0 = __shfl(t3_reg1, friend_id0);
        ty0 = __shfl(t3_reg2, friend_id0);
        tx1 = __shfl(t3_reg2, friend_id1);
        ty1 = __shfl(t3_reg3, friend_id1);
        sum0 += ARG_3D(6,k,j  ,i)*((lane_id < 29)? tx0: ty0);
        sum1 += ARG_3D(6,k,j+1,i)*((lane_id < 27)? tx1: ty1);
        ...
        ty1 = __shfl(t2_reg3, friend_id1);
        sum0 += ARG_3D(4,k,j  ,i)*((lane_id < 28)? tx0: ty0);
        sum1 += ARG_3D(4,k,j+1,i)*((lane_id < 26)? tx1: ty1);
        ...
        sum0 += ARG_3D(5,k,j  ,i)*((lane_id < 27)? tx0: ty0);
        sum1 += ARG_3D(5,k,j+1,i)*((lane_id < 25)? tx1: ty1);
...
#pragma unroll // it seems the loop-unroll is useless to performance
    for(; k < k_end; ++k)
    {
        ...
        sum0 += ARG_3D(0,k,j  ,i)*((lane_id < 29)? tx0: ty0);
        sum1 += ARG_3D(0,k,j+1,i)*((lane_id < 27)? tx1: ty1);
        sum2 += ARG_3D(0,k,j+2,i)*((lane_id < 25)? tx2: ty2);
        sum3 += ARG_3D(0,k,j+3,i)*((lane_id < 23)? tx3: ty3);
        tx0 = __shfl(t2_reg1, friend_id0);
        ty0 = __shfl(t2_reg2, friend_id0);
        tx1 = __shfl(t2_reg2, friend_id1);
        ty1 = __shfl(t2_reg3, friend_id1);
        ...
        sum0 += ARG_3D(3,k,j  ,i)*((lane_id < 29)? tx0: ty0);
        sum1 += ARG_3D(3,k,j+1,i)*((lane_id < 27)? tx1: ty1);
        sum2 += ARG_3D(3,k,j+2,i)*((lane_id < 25)? tx2: ty2);
        sum3 += ARG_3D(3,k,j+3,i)*((lane_id < 23)? tx3: ty3);
        tx0 = __shfl(t3_reg1, friend_id0);
        ty0 = __shfl(t3_reg2, friend_id0);
        tx1 = __shfl(t3_reg2, friend_id1);
        ty1 = __shfl(t3_reg3, friend_id1);
        ...
        sum0 += ARG_3D(6,k,j  ,i)*((lane_id < 29)? tx0: ty0);
        sum1 += ARG_3D(6,k,j+1,i)*((lane_id < 27)? tx1: ty1);
        sum2 += ARG_3D(6,k,j+2,i)*((lane_id < 25)? tx2: ty2);
        sum3 += ARG_3D(6,k,j+3,i)*((lane_id < 23)? tx3: ty3);
        ...
        sum0 += ARG_3D(4,k,j  ,i)*((lane_id < 28)? tx0: ty0);
        sum1 += ARG_3D(4,k,j+1,i)*((lane_id < 26)? tx1: ty1);
        sum2 += ARG_3D(4,k,j+2,i)*((lane_id < 24)? tx2: ty2);
        sum3 += ARG_3D(4,k,j+3,i)*((lane_id < 22)? tx3: ty3);
        ...
        sum0 += ARG_3D(5,k,j  ,i)*((lane_id < 27)? tx0: ty0);
        sum1 += ARG_3D(5,k,j+1,i)*((lane_id < 25)? tx1: ty1);
        sum2 += ARG_3D(5,k,j+2,i)*((lane_id < 23)? tx2: ty2);
        sum3 += ARG_3D(5,k,j+3,i)*((lane_id < 21)? tx3: ty3);
...
int main(int argc, char **argv)
{
    ...
    for(int i =0; i< ITER; i++)
    {
        Stencil_Cuda_Sweep<<<dimGrid, dimBlock>>>(in_d, out_d, args_d, z, m, n, halo);
        swap(in_d, out_d);
    }
    swap(in_d, out_d);
    cudaEventRecord(stop);
    ...
    for(int i =0; i< ITER; i++)
    {
        Stencil_Cuda_Sm_Branch<<<dimGrid, dimBlock>>>(in_d, out_d, args_d, z, m, n, halo);
        swap(in_d, out_d);
    }
    swap(in_d, out_d);
    cudaEventRecord(stop);
    ...
    for(int i =0; i< ITER; i++)
    {
        Stencil_Cuda_Sm_Cyclic<<<dimGrid, dimBlock>>>(in_d, out_d, args_d, z, m, n, halo);
        swap(in_d, out_d);
    }
    swap(in_d, out_d);
    cudaEventRecord(stop);
    ...
    for(int i =0; i< ITER; i++)
    {
        Stencil_Cuda_Sweep_Sm_Branch<<<dimGrid, dimBlock>>>(in_d, out_d, args_d, z, m, n, halo);
        swap(in_d, out_d);
    }
    swap(in_d, out_d);
    cudaEventRecord(stop);
    ...
    for(int i =0; i< ITER; i++)
    {
        Stencil_Cuda_Sweep_Sm_Cyclic<<<dimGrid, dimBlock>>>(in_d, out_d, args_d, z, m, n, halo);
        swap(in_d, out_d);
    }
    swap(in_d, out_d);
    cudaEventRecord(stop);
    ...
    for(int i =0; i< ITER; i++)
    {
        Stencil_Cuda_Shfl_2DWarp<<<dimGrid, dimBlock>>>(in_d, out_d, args_d, z, m, n, halo);
        swap(in_d, out_d);
    }
    swap(in_d, out_d);
    cudaEventRecord(stop);
    ...
    for(int i =0; i< ITER; i++)
    {
        Stencil_Cuda_Shfl2_2DWarp<<<dimGrid, dimBlock>>>(in_d, out_d, args_d, z, m, n, halo);
        swap(in_d, out_d);
    }
    swap(in_d, out_d);
    cudaEventRecord(stop);
    ...
    for(int i =0; i< ITER; i++)
    {
        Stencil_Cuda_Shfl4_2DWarp<<<dimGrid, dimBlock>>>(in_d, out_d, args_d, z, m, n, halo);
        swap(in_d, out_d);
    }
    swap(in_d, out_d);
    cudaEventRecord(stop);
    ...
    */
    ...
    for(int i =0; i< ITER; i++)
    {
        Stencil_Cuda_Sweep_Shfl_1DWarp<<<dimGrid, dimBlock>>>(in_d, out_d, args_d, z, m, n, halo);
        swap(in_d, out_d);
    }
    swap(in_d, out_d);
    cudaEventRecord(stop);
    ...
    for(int i =0; i< ITER; i++)
    {
        Stencil_Cuda_Sweep_Shfl2_1DWarp<<<dimGrid, dimBlock>>>(in_d, out_d, args_d, z, m, n, halo);
        swap(in_d, out_d);
    }
    swap(in_d, out_d);
    cudaEventRecord(stop);
    ...
    for(int i =0; i< ITER; i++)
    {
        Stencil_Cuda_Sweep_Shfl4_1DWarp<<<dimGrid, dimBlock>>>(in_d, out_d, args_d, z, m, n, halo);
        swap(in_d, out_d);
    }
    swap(in_d, out_d);
    cudaEventRecord(stop);
