...
#pragma unroll 
        for(; k < k_end; ++k)
        {
            ...
            OUT_3D(k,j,i) = ARG_3D(0,k,j,i) * LOC_3D(t1,lj  ,li  ) +
                            ARG_3D(1,k,j,i) * LOC_3D(t2,lj-1,li  ) + 
                            ARG_3D(2,k,j,i) * LOC_3D(t2,lj  ,li-1) + 
                            ARG_3D(3,k,j,i) * LOC_3D(t2,lj  ,li  ) + 
                            ARG_3D(4,k,j,i) * LOC_3D(t2,lj  ,li+1) + 
                            ARG_3D(5,k,j,i) * LOC_3D(t2,lj+1,li  ) + 
                            ARG_3D(6,k,j,i) * LOC_3D(t3,lj  ,li  ) ;
        }
    });
    fut.wait();
}
        ...
        int z, int m, int n, int halo)
{
    ...
    completion_future fut = parallel_for_each(comp_tile, [=, &in, &out, &args](tiled_index<3> tidx) restrict(amp) {
        ...
        sum0 +=ARG_3D(0,k  ,j,i)*((lane_id < 43)? tx0: ty0);
        sum1 +=ARG_3D(0,k+1,j,i)*((lane_id < 15)? tx1: ty1);
        ...
        sum0 +=ARG_3D(1,k  ,j,i)*((lane_id < 23)? tx0: ty0);
        sum1 +=ARG_3D(1,k+1,j,i)*((lane_id < 45)? tx1: ty1);
        ...
        ty1 = __shfl(reg4, friend_id1);
        sum0 +=ARG_3D(2,k  ,j,i)*((lane_id < 16)? tx0: ty0);
        sum1 +=ARG_3D(2,k+1,j,i)*((lane_id < 38)? tx1: ty1);
        ...
        ty1 = __shfl(reg4, friend_id1);
        sum0 +=ARG_3D(3,k  ,j,i)*((lane_id < 15)? tx0: ty0);
        sum1 +=ARG_3D(3,k+1,j,i)*((lane_id < 37)? tx1: ty1);
        ...
        ty1 = __shfl(reg4, friend_id1);
        sum0 +=ARG_3D(4,k  ,j,i)*((lane_id < 14)? tx0: ty0);
        sum1 +=ARG_3D(4,k+1,j,i)*((lane_id < 36)? tx1: ty1);
        ...
        ty1 = __shfl(reg4, friend_id1);
        sum0 +=ARG_3D(5,k  ,j,i)*((lane_id < 7 )? tx0: ((lane_id < 57)? ty0: tz0));
        sum1 +=ARG_3D(5,k+1,j,i)*((lane_id < 29)? tx1: ty1);
        ...
        sum0 +=ARG_3D(6,k  ,j,i)*((lane_id < 37)? tx0: ty0);
        sum1 +=ARG_3D(6,k+1,j,i)*((lane_id < 8 )? tx1: ((lane_id < 59)? ty1: tz1));
        ...
        int z, int m, int n, int halo)
{
    ...
    completion_future fut = parallel_for_each(comp_tile, [=, &in, &out, &args](tiled_index<3> tidx) restrict(amp) {
        ...
        sum0 +=ARG_3D(0,k  ,j,i)*((lane_id < 43)? tx0: ty0);
        sum1 +=ARG_3D(0,k+1,j,i)*((lane_id < 15)? tx1: ty1);
        sum2 +=ARG_3D(0,k+2,j,i)*((lane_id < 37)? tx2: ty2);
        sum3 +=ARG_3D(0,k+3,j,i)*((lane_id < 8 )? tx3: ((lane_id < 59)? ty3: tz3));
        ...
        sum0 +=ARG_3D(1,k  ,j,i)*((lane_id < 23)? tx0: ty0);
        sum1 +=ARG_3D(1,k+1,j,i)*((lane_id < 45)? tx1: ty1);
        sum2 +=ARG_3D(1,k+2,j,i)*((lane_id < 16)? tx2: ty2);
        sum3 +=ARG_3D(1,k+3,j,i)*((lane_id < 39)? tx3: ty3);
        ...
        sum0 +=ARG_3D(2,k  ,j,i)*((lane_id < 16)? tx0: ty0);
        sum1 +=ARG_3D(2,k+1,j,i)*((lane_id < 38)? tx1: ty1);
        sum2 +=ARG_3D(2,k+2,j,i)*((lane_id < 8 )? tx2: ((lane_id < 60)? ty2: tz2));
        sum3 +=ARG_3D(2,k+3,j,i)*((lane_id < 32)? tx3: ty3);
        ...
        sum0 +=ARG_3D(3,k  ,j,i)*((lane_id < 15)? tx0: ty0);
        sum1 +=ARG_3D(3,k+1,j,i)*((lane_id < 37)? tx1: ty1);
        sum2 +=ARG_3D(3,k+2,j,i)*((lane_id < 8 )? tx2: ((lane_id < 59)? ty2: tz2));
        sum3 +=ARG_3D(3,k+3,j,i)*((lane_id < 31)? tx3: ty3);
        ...
        sum0 +=ARG_3D(4,k  ,j,i)*((lane_id < 14)? tx0: ty0);
        sum1 +=ARG_3D(4,k+1,j,i)*((lane_id < 36)? tx1: ty1);
        sum2 +=ARG_3D(4,k+2,j,i)*((lane_id < 8 )? tx2: ((lane_id < 58)? ty2: tz2));
        sum3 +=ARG_3D(4,k+3,j,i)*((lane_id < 30)? tx3: ty3);
        ...
        sum0 +=ARG_3D(5,k  ,j,i)*((lane_id < 7 )? tx0: ((lane_id < 57)? ty0: tz0));
        sum1 +=ARG_3D(5,k+1,j,i)*((lane_id < 29)? tx1: ty1);
        sum2 +=ARG_3D(5,k+2,j,i)*((lane_id < 51)? tx2: ty2);
        ...
        sum0 +=ARG_3D(6,k  ,j,i)*((lane_id < 37)? tx0: ty0);
        sum1 +=ARG_3D(6,k+1,j,i)*((lane_id < 8 )? tx1: ((lane_id < 59)? ty1: tz1));
        sum2 +=ARG_3D(6,k+2,j,i)*((lane_id < 31)? tx2: ty2);
        sum3 +=ARG_3D(6,k+3,j,i)*((lane_id < 1 )? tx3: ((lane_id < 53)? ty3: tz3));
...
#pragma unroll 
        for(; k < k_end; ++k)
        {
            ...
            sum0 +=ARG_3D(0,k,j,i)*((lane_id < 61)? tx0: ty0);
            tx0 = __shfl(t2_reg1, friend_id0);
            ty0 = __shfl(t2_reg2, friend_id0);
            sum0 +=ARG_3D(3,k,j,i)*((lane_id < 61)? tx0: ty0);
            tx0 = __shfl(t3_reg1, friend_id0);
            ty0 = __shfl(t3_reg2, friend_id0);
            sum0 +=ARG_3D(6,k,j,i)*((lane_id < 61)? tx0: ty0);

            friend_id0 = (lane_id+4 )&(warpSize-1);
            tx0 = __shfl(t2_reg1, friend_id0);
            ty0 = __shfl(t2_reg2, friend_id0);
            sum0 +=ARG_3D(4,k,j,i)*((lane_id < 60)? tx0: ty0);

            friend_id0 = (lane_id+5 )&(warpSize-1);
            tx0 = __shfl(t2_reg2, friend_id0);
            ty0 = __shfl(t2_reg3, friend_id0);
            sum0 +=ARG_3D(5,k,j,i)*((lane_id < 59)? tx0: ty0);
...
#pragma unroll 
        for(; k < k_end; ++k)
        {
            ...
            sum0 +=ARG_3D(0,k,j  ,i)*((lane_id < 61)? tx0: ty0);
            sum1 +=ARG_3D(0,k,j+1,i)*((lane_id < 59)? tx1: ty1);
            tx0 = __shfl(t2_reg1, friend_id0);
            ty0 = __shfl(t2_reg2, friend_id0);
            tx1 = __shfl(t2_reg2, friend_id1);
            ty1 = __shfl(t2_reg3, friend_id1);
            sum0 +=ARG_3D(3,k,j  ,i)*((lane_id < 61)? tx0: ty0);
            sum1 +=ARG_3D(3,k,j+1,i)*((lane_id < 59)? tx1: ty1);
            tx0 = __shfl(t3_reg1, friend_id0);
            ty0 = __shfl(t3_reg2, friend_id0);
            tx1 = __shfl(t3_reg2, friend_id1);
            ty1 = __shfl(t3_reg3, friend_id1);
            sum0 +=ARG_3D(6,k,j  ,i)*((lane_id < 61)? tx0: ty0);
            sum1 +=ARG_3D(6,k,j+1,i)*((lane_id < 59)? tx1: ty1);
            ...
            ty1 = __shfl(t2_reg3, friend_id1);
            sum0 +=ARG_3D(4,k,j  ,i)*((lane_id < 60)? tx0: ty0);
            sum1 +=ARG_3D(4,k,j+1,i)*((lane_id < 58)? tx1: ty1);
            ...
            sum0 +=ARG_3D(5,k,j  ,i)*((lane_id < 59)? tx0: ty0);
            sum1 +=ARG_3D(5,k,j+1,i)*((lane_id < 57)? tx1: ty1);
...
#pragma unroll 
        for(; k < k_end; ++k)
        {
            ...
            sum0 +=ARG_3D(0,k,j  ,i)*((lane_id < 61)? tx0: ty0);
            sum1 +=ARG_3D(0,k,j+1,i)*((lane_id < 59)? tx1: ty1);
            sum2 +=ARG_3D(0,k,j+2,i)*((lane_id < 57)? tx2: ty2);
            sum3 +=ARG_3D(0,k,j+3,i)*((lane_id < 55)? tx3: ty3);
            tx0 = __shfl(t2_reg1, friend_id0);
            ty0 = __shfl(t2_reg2, friend_id0);
            tx1 = __shfl(t2_reg2, friend_id1);
            ty1 = __shfl(t2_reg3, friend_id1);
            ...
            sum0 +=ARG_3D(3,k,j  ,i)*((lane_id < 61)? tx0: ty0);
            sum1 +=ARG_3D(3,k,j+1,i)*((lane_id < 59)? tx1: ty1);
            sum2 +=ARG_3D(3,k,j+2,i)*((lane_id < 57)? tx2: ty2);
            sum3 +=ARG_3D(3,k,j+3,i)*((lane_id < 55)? tx3: ty3);
            tx0 = __shfl(t3_reg1, friend_id0);
            ty0 = __shfl(t3_reg2, friend_id0);
            tx1 = __shfl(t3_reg2, friend_id1);
            ty1 = __shfl(t3_reg3, friend_id1);
            ...
            sum0 +=ARG_3D(6,k,j  ,i)*((lane_id < 61)? tx0: ty0);
            sum1 +=ARG_3D(6,k,j+1,i)*((lane_id < 59)? tx1: ty1);
            sum2 +=ARG_3D(6,k,j+2,i)*((lane_id < 57)? tx2: ty2);
            sum3 +=ARG_3D(6,k,j+3,i)*((lane_id < 55)? tx3: ty3);
            ...
            sum0 +=ARG_3D(4,k,j  ,i)*((lane_id < 60)? tx0: ty0);
            sum1 +=ARG_3D(4,k,j+1,i)*((lane_id < 58)? tx1: ty1);
            sum2 +=ARG_3D(4,k,j+2,i)*((lane_id < 56)? tx2: ty2);
            sum3 +=ARG_3D(4,k,j+3,i)*((lane_id < 54)? tx3: ty3);
            ...
            sum0 +=ARG_3D(5,k,j  ,i)*((lane_id < 59)? tx0: ty0);
            sum1 +=ARG_3D(5,k,j+1,i)*((lane_id < 57)? tx1: ty1);
            sum2 +=ARG_3D(5,k,j+2,i)*((lane_id < 55)? tx2: ty2);
            sum3 +=ARG_3D(5,k,j+3,i)*((lane_id < 53)? tx3: ty3);
...
int main(int argc, char **argv)
{
...
#ifdef __DEBUG
    Init_Args_3D(args, 7, z, m, n, halo, 1.0);
#else
    Init_Args_3D(args, 7, z, m, n, halo, 0.14);
#endif
    ...
    printf("Throughput   : %.3f (GB/s)\n", GetThroughput(ARGC_3D7, z+2*halo, m+2*halo, n+2*halo, ITER, time_wo_pci, sizeof(DATA_TYPE)));
