...
__global__ void Stencil_Cuda_L1_1Blk(DATA_TYPE *in, DATA_TYPE *out, 
        DATA_TYPE a0, DATA_TYPE a1, DATA_TYPE a2,
        DATA_TYPE a3, DATA_TYPE a4, DATA_TYPE a5, DATA_TYPE a6, 
        int n, int halo) 
{
...
__global__ void Stencil_Cuda_Reg1_1Blk1Wf(DATA_TYPE *in, DATA_TYPE *out, DATA_TYPE a0, DATA_TYPE a1, DATA_TYPE a2,
        DATA_TYPE a3, DATA_TYPE a4, DATA_TYPE a5, DATA_TYPE a6 , int n, int halo) 
{
    ...
    int lane_id_it = lane_id;
    int new_id0 ;
    new_id0 = (warp_id0<<5) + lane_id_it%38 ;
    reg0 = IN_1D(new_id0) ;
    lane_id_it += 32 ;
    new_id0 = (warp_id0<<5) + (lane_id_it/38)*38 + lane_id_it%38 ;
...
__global__ void Stencil_Cuda_Reg2_1Blk1Wf(DATA_TYPE *in, DATA_TYPE *out, 
        DATA_TYPE a0, DATA_TYPE a1, DATA_TYPE a2,
        DATA_TYPE a3, DATA_TYPE a4, DATA_TYPE a5, DATA_TYPE a6, 
        int n, int halo) 
{
...
__global__ void Stencil_Cuda_Reg4_1Blk1Wf(DATA_TYPE *in, DATA_TYPE *out, DATA_TYPE a0, DATA_TYPE a1, DATA_TYPE a2,
        DATA_TYPE a3, DATA_TYPE a4, DATA_TYPE a5, DATA_TYPE a6 , int n, int halo) 
{
    unsigned int tid = threadIdx.x;
    unsigned int lane_id = tid % warpSize;
    ...
    ty1 = __shfl(reg2, friend_id1);
    sum1 += a3 *((lane_id < 29 )? tx1: ty1);
    friend_id2 = (lane_id+ 3)&31 ;
    tx2 = __shfl(reg2, friend_id2);
    ty2 = __shfl(reg3, friend_id2);
    sum2 += a3 *((lane_id < 29 )? tx2: ty2);
    friend_id3 = (lane_id+ 3)&31 ;
    tx3 = __shfl(reg3, friend_id3);
    ty3 = __shfl(reg4, friend_id3);
...
int main(int argc, char **argv)
{
    ...
    for(int i=0; i< ITER; i++)
    {
        Stencil_Cuda_L1_1Blk<<<dimGrid, dimBlock>>>(in_d, out_d, 
                args[0], args[1], args[2], args[3], args[4], args[5], args[6], 
                n, halo);
        swap(in_d, out_d);
    }
    ...
    for(int i=0; i< ITER; i++)
    {
        Stencil_Cuda_Lds_1BlkBrc<<<dimGrid, dimBlock>>>(in_d, out_d, 
                args[0], args[1], args[2], args[3], args[4], args[5], args[6], 
                n, halo);
        swap(in_d, out_d);
    }
    ...
    for(int i=0; i< ITER; i++)
    {
        Stencil_Cuda_Lds_1BlkCyc<<<dimGrid, dimBlock>>>(in_d, out_d, 
                args[0], args[1], args[2], args[3], args[4], args[5], args[6], 
                n, halo);
        swap(in_d, out_d);
    }
    ...
    for(int i=0; i< ITER; i++)
    {
        Stencil_Cuda_Reg1_1Blk1Wf<<<dimGrid, dimBlock>>>(in_d, out_d, 
                args[0], args[1], args[2], args[3], args[4], args[5], args[6], 
                n, halo);
        swap(in_d, out_d);
    }
    ...
    for(int i=0; i< ITER; i++)
    {
        Stencil_Cuda_Reg2_1Blk1Wf<<<dimGrid, dimBlock>>>(in_d, out_d, 
                args[0], args[1], args[2], args[3], args[4], args[5], args[6], 
                n, halo);
        swap(in_d, out_d);
    }
    ...
    for(int i=0; i< ITER; i++)
    {
        Stencil_Cuda_Reg4_1Blk1Wf<<<dimGrid, dimBlock>>>(in_d, out_d, 
                args[0], args[1], args[2], args[3], args[4], args[5], args[6], 
                n, halo);
        swap(in_d, out_d);
    }
